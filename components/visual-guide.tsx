...
export default function VisualGuide() {
  ...
  const getWelcomeMessage = () => {
    const messages = {
      ...
      bn: "ফার্মগার্ডে স্বাগতম! আমি আপনাকে এই কৃষি অ্যাপ ব্যবহার করতে সাহায্য করব। প্রথমে আপনার ভাষা বেছে নিন, তারপর সাইন ইন ক্লিক করুন।"
    }
  ...
  const getUITexts = () => {
    const texts = {
      ...
      bn: {
        ...
        description: "আমি আপনাকে এই কৃষি অ্যাপ ব্যবহার করতে সাহায্য করব।",
        firstStep: "প্রথমে, আপনার ভাষা বেছে নিন",
        secondStep: 'তারপর চালিয়ে যেতে "সাইন ইন" ক্লিক করুন',
        gotIt: "বুঝেছি!",
        changeLanguage: "ভাষা পরিবর্তন",
        clickToStart: "শুরু করতে ক্লিক করুন"
      }
    }
